...
import com.example.smartkitchenandroid.databinding.FragmentKitchenCoordinatorBinding
import com.google.android.material.tabs.TabLayoutMediator


class KitchenCoordinatorFragment : Fragment() {

    private val tabs = arrayOf("Todo", "Done")
    private var _binding: FragmentKitchenCoordinatorBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentKitchenCoordinatorBinding.inflate(inflater, container, false)
        init()
        return binding.root
    }
